...
#identify the files you want to read in 
  ...
  data_files <- c("COMPASS_Box7_MonMon_NUTR_noPO4_385-465_Feb2023_JB.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/COMPASS_Box7_MonMon_NUTR_noPO4_385-465_Feb2023_JB.csv"
  final_path <- "Processed Data/COMPASS_Box7_MonMon_NUTR_noPO4_385-465_Feb2023_JB.csv"
...
raw_metadata <- read.csv(Metadata_Porewater_LE_Nutrients)
