...
r2_summary <- fluxes_all %>%
  ...
  summarise(
    total_obs = n(),
    n_lin_r2_below_0.9 = sum(lin_bad),
    pct_lin_r2_below_0.9 = 100 * n_lin_r2_below_0.9 / total_obs,
    n_fail_all_models = sum(fail_all_models),
    pct_fail_all_models = 100 * n_fail_all_models / total_obs,
    n_pass_at_least_one = sum(pass_at_least_one),
...
#   filter(!Plot %in% c( disturbed during measurement?
#                       ))
# 
# 
# # View the result
