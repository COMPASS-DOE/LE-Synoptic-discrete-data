---
title: "COMPASS_Synoptic_LE_Tree_GHG_Flux_Calcs"
...
metadat <- dat %>%
  ...
  filter(SN %in% c("TG10-01448", "TG10-01426")) %>%
...
#     filter(
#         SN == "TG10-01448",
#         TIMESTAMP > as.POSIXct("2023-01-05 13:28:00", tz = "EST"),
#         TIMESTAMP < as.POSIXct("2023-01-05 13:33:00", tz = "EST")
#     ) %>%
...
write.csv(allflux_filtered_renamed, file="Processed Data/COMPASS_Synoptic_LE_TreeStem_Fluxes_Final_2022_2023_CH4.csv", row.names = FALSE)
# #Change file name
```
