---
title: "COMPASS_Synoptic_LE_Tree_Flux_Calcs_2023_CH4"
...
metadat <- dat %>%
  ...
  mutate(
    ...
    Site = toupper(Site),
    Zone = toupper(Zone), 
    Replicate = str_extract(Plot_raw, "(?<=(TR|UP))[0-9]+") |> as.integer(),
...
time_overrides <- tibble::tibble(
  Plot = c("7/13/2023_CRC_UP_302_226","5/10/2023_OWC_TR_121_163","7/13/2023_CRC_TR_315_237","5/10/2023_CRC_UP_304_182",
           "3/28/2023_OWC_TR_127_131","6/29/2023_CRC_UP_305_213","5/10/2023_OWC_TR_127_168","7/13/2023_CRC_UP_304_227",
           "6/29/2023_CRC_UP_306_214","7/13/2023_CRC_TR_314_236","3/24/2023_CRC_UP_2_103","2/24/2023_PTR_UP_4_100",
           "6/29/2023_CRC_TR_311_219","2/10/2023_OWC_UP_101_49","7/13/2023_CRC_UP_307_B_241","7/13/2023_CRC_UP_306_229",
           "7/13/2023_CRC_UP_308_B_240","2/21/2023_CRC_UP_308_72","2/21/2023_CRC_TR_314_78","3/28/2023_OWC_UP_104_120",
           "2/21/2023_CRC_UP_304_68"
  ),
  dead_band_manual = c(20,11,10,20,20,10,20,20,10,23,60,60,6,14,30,25,15,5,10,10,10
    ),
...
# new offset
t_end_adjusted = if_else(!is.na(stop_offset_secs),
...
alldat_trimmed$CH4_nmol_m2 <- alldat_trimmed$CH4_nmol / alldat_trimmed$Area

fluxes <- ffi_compute_fluxes(alldat_trimmed ,
                             group_column = "Plot", 
                             time_column = "TIMESTAMP", 
                             gas_column = "CH4_nmol_m2", 
                             dead_band = 0) #we have fixed dead band in the previous chunk
head(fluxes)
...
tidyr::pivot_longer(everything(), names_to = "Metric", values_to = "Value") %>%
          ...
          kableExtra::pack_rows("Rejections", 2, 3) %>%
          kableExtra::pack_rows("Model performance", 4, 6)
...
pivot_longer(cols = -CH4_neg_flux,#cols = everything(),
...
manual_reject <- c("2/24/2023_PTR_UP_6_101", #leak
                   "1/5/2023_OWC_UP_103_3",  #Flat line with one low value in the midle
                   "1/5/2023_OWC_UP_107_123"  #Flat line with one low value in the midle
)
...
allflux_filtered <-fluxes_flagged%>%filter(!CH4_flux_rejected)
