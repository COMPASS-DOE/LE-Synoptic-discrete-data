...
saveRDS(alldat_matched, file = "alldat_matched_2023b.rds")
...
alldat_matched <- readRDS("alldat_matched_2023b.rds")
```
...
write.csv(allflux_filtered_renamed, file="Processed Data/COMPASS_Synoptic_LE_TreeStem_Fluxes_Final_2023b_CO2.csv", row.names = FALSE)
# #Change file name
```
